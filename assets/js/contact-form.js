(function($) {
    ...
    var contactForm = {
        ...
        emailjsConfig: {
            serviceId: 'service_ypxzbva',    // EmailJS Service ID
            templateId: 'template_lrb1mmk',  // EmailJS Template ID
            publicKey: 'KeeDIZDTSrheB0Ymz'  // EmailJS Public Key
        },
        ...
        sendWithEmailJS: function(formData) {
            ...
            emailjs.send(
                ...
                {
                    to_name: 'Cadfy Vision Team',
                    to_email: 'jnadal@cadfyvision.com.au',
